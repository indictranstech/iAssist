...
function render_status_box(frm) {
	if (!frm.fields_dict || !frm.fields_dict.custom_status_box) return;
	...
	frm.fields_dict.custom_status_box.$wrapper.empty();
	...
	frm.fields_dict.custom_status_box.$wrapper.append(html);
}
